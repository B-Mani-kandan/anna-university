...
app.post(
  ...
  catchAsync(async (req, res) => {
    ...
    let a = {
      type: "point",
      coordinates: [
        Number(req.body.jform.Longitude),
        Number(req.body.jform.Latitude),
      ],
    };
